...
{
  "template": "체험 제목: \"[제목]\"\\n\\n1) 오프닝 ([분])\\n- ...\\n\\n2) 준비 단계 ([분])\\n- ...\\n\\n3) 핵심 체험 ([분])\\n- Step 1: ...\\n- Step 2: ...\\n\\n4) 마무리 ([분])\\n- ...",
  "클래스 소개": "...이 클래스가 무엇을 다루는지 한 문단으로 설명...",
  "난이도": "초급 | 중급 | 고급 중 하나",
  "로드맵": "이 클래스를 통해 확장 가능한 활동/진로/콘텐츠에 대한 설명"
}
모든 키(template, 클래스 소개, 난이도, 로드맵)를 반드시 포함해야 하며, 값은 문자열입니다.
</output_structure_json>
...
3. JSON 키는 template, 클래스 소개, 난이도, 로드맵 네 개를 모두 포함합니다.
4. 시간/섹션/불릿은 template 문자열 안에서 표현합니다.
